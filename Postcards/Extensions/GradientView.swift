...
//  Postcards
//
//  Created by Raul Mena on 1/15/19.
...
class GradientView: UIView{
    ...
    var gradientBackgroundColor : CGColor = UIColor.darkGray.cgColor//UIColor(white: 0.85, alpha: 1.0).cgColor
    var gradientMovingColor : CGColor = UIColor.lightGray.cgColor//UIColor(white: 0.75, alpha: 1.0).cgColor
    
    var movingAnimationDuration : CFTimeInterval = 0.5
    var delayBetweenAnimationLoops : CFTimeInterval = 0.8
